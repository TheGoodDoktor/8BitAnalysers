...
class FASMExporterBase : public FASMExporter
{
	public:
...
class FSJasmPlusExporter : public FASMExporterBase
{
public:
	FSJasmPlusExporter()
	{
...
class FSpasmExporter : public FASMExporterBase
{
public:
	FSpasmExporter()
	{
...
class FEZ80AsmExporter : public FASMExporterBase
{
public:
	FEZ80AsmExporter()
	{
